...
<div class="col-md-10">
<a href="mailto:emailkcpg7619@gmail.com" style="color:#000000">emailkcpg7619@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
		<div class="col-md-5">
		 <img src="image/img1.jpg" width=180 height=200 alt="CAS" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<h1 style="color:#202020; font-family:'typo' ; font-size:18px">Chaitrali Kadam | Asavari Bhosale | Samrudhi Ingale</h1>
   
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7793851086</h4>
		<h4 style="font-family:'typo' ">crkadam01@gmail.com</h4>
		<h4 style="font-family:'typo' ">SVERI's COE ,Pandharpur</h4></div></div>
		</p>
      </div>
